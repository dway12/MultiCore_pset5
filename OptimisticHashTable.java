...
class OptimisticHashTable<T> implements HashTable<T> {
  ...
  public OptimisticHashTable(int logSize,int numThreads, int maxBucketSize) {
...
class OptimisticHashTableTest {
  public static void main(String[] args) {
    OptimisticHashTable<Integer> table = new OptimisticHashTable<Integer>(2,6,8);
    for (int i = 0; i < 256; i++) {
      table.add(i, i*i);
    }
    table.printTable();
